...
int hasGreatGrandchild(BTNode *node)
{
    ...
    int right_height = hasGreatGrandchild(node->right)+1;
    int left_height = hasGreatGrandchild(node->left)+1;
    int height = right_height < left_height ? left_height :right_height;
